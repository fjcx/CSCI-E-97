...
/**
 * Custom Exception to be thrown if exception occurs while creating a Collectable object.
 * @author Frank O'Connor
 *
 */
public class CollectableChildException extends Exception {
	 ...
	 */
	public CollectableChildException(String msg, String line, int lineNum, String filename, Throwable cause) {
		super("CollectableChildException has occured: " + msg, cause);
