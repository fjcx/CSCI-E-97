...
/**
 * Custom Exception to be thrown if exception occurs while referencing an object.
...
public class InvalidReferenceException extends Exception {
	 ...
	 */
	public InvalidReferenceException(String msg, String line, int lineNum, String filename, Throwable cause) {
		super("InvalidReferenceException has occured: " + msg, cause);
