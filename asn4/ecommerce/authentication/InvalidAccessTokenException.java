...
/**
 * Custom Exception to be thrown if exception occurs while referencing an inactive access token.
...
public class InvalidAccessTokenException extends Exception {
	 ...
	 */
	public InvalidAccessTokenException(String msg, String line, int lineNum, String filename, Throwable cause) {
		super("InvalidAccessTokenException has occured: " + msg, cause);
